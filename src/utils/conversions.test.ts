...
import { volume, weight, temperature, gravity, color, bitterness } from './conversions.js';
...
describe('Gravity Calculations', () => {
  ...
  it('should convert SG to points', () => {
    expect(gravity.sgToPoints(1.050)).toBeCloseTo(50, 5);
  });

  it('should convert points to SG', () => {
    expect(gravity.pointsToSg(50)).toBe(1.050);
  });

  it('should calculate ABV', () => {
    const abv = gravity.calculateAbv(1.055, 1.010);
    expect(abv).toBeCloseTo(5.91, 1);
  });

  it('should calculate attenuation', () => {
    const attenuation = gravity.calculateAttenuation(1.050, 1.010);
...
describe('Bitterness Calculations', () => {
  ...
  it('should show utilization increases with time', () => {
    const util30 = bitterness.tinsethUtilization(30, 1.050);
    const util60 = bitterness.tinsethUtilization(60, 1.050);
